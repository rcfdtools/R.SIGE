...
| Avance **P2** | :compass:Mapa digital impreso _P2-1: Límites veredales_<br>(incluir los diferentes límites obtenidos en la actividad [Análisis veredal y límite territorial](../CountyLimit/Readme.md) con vectores, tablas y gráficos de análisis.)                                                                                                                                                                                                                | 
| Avance **P2** | :compass:Mapa digital impreso _P2-1: Límites municipales_<br>(incluir los diferentes límites obtenidos en la actividad [Análisis veredal y límite territorial](../CountyLimit/Readme.md) con vectores, tablas y gráficos de análisis.)                                                                                                                                                                                                                | 
