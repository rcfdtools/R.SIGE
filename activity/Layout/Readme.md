...
| Avance **P2** | :compass:Mapa digital impreso P2-1: Límites veredales<br>(incluir los diferentes límites obtenidos en la actividad [Análisis veredal y límite territorial](../CountyLimit/Readme.md) con vectores, tablas y gráficos de análisis.)                                                                                                                                                                                                                           | 
| Avance **P2** | :compass:Mapa digital impreso P2-1: Límites municipales<br>(incluir los diferentes límites obtenidos en la actividad [Análisis veredal y límite territorial](../CountyLimit/Readme.md) con vectores, tablas y gráficos de análisis.)                                                                                                                                                                                                                                                                     | 
