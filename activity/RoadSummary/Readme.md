...
| Avance **P2** | Calcule la densidad vial municipal, urbana y rural en km/km² a partir de la sumatoria de las longitudes viales y el análisis de áreas geopolíticas realizado en la actividad [Análisis veredal y límite territorial](../CountyLimit/Readme.md).                                                                                                                                                                                                     | 
