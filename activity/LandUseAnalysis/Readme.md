...
| Avance **P2** | :compass:Mapa digital impreso _P2-3: Categorías de suelo con tabla de distribución y comparación_<br>(Incluir tablas de resultados y gráficos de análisis. Embebidos dentro del informe final como una imágen y referenciados como anexo.                                                                                                                                                                                                           | 
...
| [:arrow_backward: Anterior](../Layout/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.SIGE/discussions/14) | [Siguiente :arrow_forward:]() |
|--------------------------------------------------|-----------------------------------|-----------------------------------------------------------------------------------|-------------------------------|
