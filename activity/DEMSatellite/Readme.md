...
| Actividad     | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|:--------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Avance **P5** | Descargue y evalúe para su caso de estudio los diferentes modelos digitales de elevación presentados en esta actividad y presente los análisis realizados.                                                                                                                                                                                                                                                                                          | 
| Avance **P5** | :compass:Mapa digital impreso _P5-4: Comparación de modelos digitales POT, ASTER GDEM, SRTM, ALOS PALSAR y Copernicus._<br>Incluir estadísticos zonales municipales. Embebido dentro del informe final como una imágen y referenciados como anexo.                                                                                                                                                                                                  | 
...
| [:arrow_backward: Anterior](../DEMContour/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.SIGE/discussions/29) | [Siguiente :arrow_forward:](../DEMSlope/Readme.md) |
|------------------------------------------------------|-----------------------------------|-----------------------------------------------------------------------------------|----------------------------------------------------|
