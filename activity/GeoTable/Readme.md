...
| Avance **P3** | :compass:Mapa digital impreso _P3-1: Polígonos a partir de tablas geocodificadas con comparación capa MOT._<br>Incluir nodos perimetrales numerados, polígonos rotulados. Puede usar uno o varios marcos de datos para mostrar el detalle de todos los polígonos.<br>Embebido dentro del informe final como una imágen y referenciados como anexo.                                                                                                   | 
