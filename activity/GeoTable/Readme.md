...
| Avance **P3** | Compare cada zona con la capa del modelo de ocupación territorial y sin eliminar o agregar nodos, ajuste la secuencia de los puntos para obtener la delimita perimetral correcta.                                                                                                                                                                                                                                                               | 
