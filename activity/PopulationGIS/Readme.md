...
Establezca la siguiente unión (Input Field: `SUELO`, Join Field: `SUELO`), podrá observar que ahora la tabla de atributos de la disolución que tenía solo dos registros, ahora tiene 44 elementos y que los rótulos aparecen múltiples veces.
...
| [◄ Anterior](../CountyLimit/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.SIGE/discussions/12) | [Siguiente ►](../Layout/Readme.md) |
|-------------------------------------------------------|-----------------------------------|-----------------------------------------------------------------------------------|--------------------------------------------------|
