...
|----------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------| 
| Vereda_DiagnosticoPOT_TerrenoPredioRural.shp | Veredas generadas a partir de la capa de predios catastro 2010 utilizados en el diagnóstico y formulación del POT (_TERRENO_PREDIO_RURAL_) | Polígono 2D | 14        | 
...
| Actividad     | Alcance                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|:--------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Avance **P2** | Para su caso de estudio, evalúe las capas de veredas utilizadas en el diagnóstico y la formulación.                                                                                                                                                                                                                                                                                                                                                 | 
| Avance **P2** | A partir de la base predial utilizada en el diagnóstico y la formulación, cree la capa de veredas.                                                                                                                                                                                                                                                                                                                                                  | 
| Avance **P2** | Utilizando la base de datos predial más reciente, cree la capa de veredas.                                                                                                                                                                                                                                                                                                                                                                          | 
| Avance **P2** | Descargue y extraiga las veredas a partir de la última versión DANE disponible.                                                                                                                                                                                                                                                                                                                                                                     | 
| Avance **P2** | Cree las capas de límites territoriales, compare todos los límites veredales y territoriales obtenidos e identifique y evalúe en que zonas se han realizado mutaciones de suelo rural a urbano. Cree un libro de Excel como el mostrado en esta actividad.                                                                                                                                                                                          | 
| Avance **P2** | Cree diferentes perímetros urbanos a partir de la capas veredales y a partir también del mapa del modelo de ordenamiento territorial vigente, analice y explique sus diferencias.                                                                                                                                                                                                                                                                   | 
...
| [◄ Anterior](../POTLayer/Readme.md) | [:house: Inicio](../../README.md) | [:beginner: Ayuda / Colabora](https://github.com/rcfdtools/R.SIGE/discussions/11) | [Siguiente ►](../PopulationGIS/Readme.md) |
|----------------------------------------------------|-----------------------------------|-----------------------------------------------------------------------------------|---------------------------------------------------------|
