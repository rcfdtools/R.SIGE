...
|--------------------------------------------------------------------------|---------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------| 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANDENES.png)             | ANDENES             | Andenes zona urbana y centros poblados rurales próximos al área urbana                                                                                               | Línea 2D    | 766       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANDENES_CPR.png)         | ANDENES_CPR         | Andenes en centros poblados rurales próximos al área urbana                                                                                                          | Línea 2D    | 162       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANDENES_PERIMETRO.png)   | ANDENES_PERIMETRO   | Andenes en zona urbana central                                                                                                                                       | Línea 2D    | 604       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANOTACION.png)           | ANOTACION           | Puntos de interés rural                                                                                                                                              | Punto 2D    | 1851      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANOTACION_URBANO.png)    | ANOTACION_URBANO    | Puntos de interés urbano                                                                                                                                             | Punto 2D    | 158       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_CURVAS_NIVEL.png)        | CURVAS_NIVEL        | Curvas de nivel, principales cada 200 metros y secundarias cada 50 metros.                                                                                           | Línea 2D    | 149       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_EDIFICACION_RURAL.png)   | EDIFICACION_RURAL   | Nodos de localización de edificaciones en la zona rural                                                                                                              | Punto 2D    | 1828      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_EDUCATIVO.png)           | EDUCATIVO           | Nodos de localización de centros educativos                                                                                                                          | Punto 2D    | 74        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_HIDROGRAFIA.png)         | HIDROGRAFIA         | Red hidrográfica                                                                                                                                                     | Línea 2D    | 305       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_HIDROGRAFIA_Buffer.png)  | HIDROGRAFIA_Buffer  | Rondas hídricas con aferencia de 30 metros a cada lado de las líneas de la red hidrográfica                                                                          | Polígono 2D | 305       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_HIDROGRAFIA_Buffer1.png) | HIDROGRAFIA_Buffer1 | Rondas hídricas con aferencia de 30 metros a cada lado de las líneas de la red hidrográfica y para tramo de drenaje mayoritariamente dentro del límite del municipio | Polígono 2D | 264       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_LIM_NBR.png)             | LIM_NBR             | Núcleo básico rural - Límites de vías y predios                                                                                                                      | Polígono 2D | 146       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_RONDAS.png)              | RONDAS              | Rondas hídricas                                                                                                                                                      | Polígono 2D | 5         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_CPR.png)            | VIAS_CPR            | Vías interconectoras desde el centro urbano y hacia centros poblados rurales - CPR                                                                                   | Línea 2D    | 200       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_PERIMETRO.png)      | VIAS_PERIMETRO      | Vías perímetro urbano principal                                                                                                                                      | Línea 2D    | 604       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_RURALES.png)        | VIAS_RURALES        | Vías rurales                                                                                                                                                         | Línea 2D    | 774       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_URBANAS.png)        | VIAS_URBANAS        | Vías urbanas                                                                                                                                                         | Línea 2D    | 784       | 
