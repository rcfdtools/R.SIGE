...
|-------------------------------------------|-----------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------| 
| CARTOGRAFIA                               | ANDENES                           | Andenes zona urbana y centros poblados rurales próximos al área urbana                                                                                               | Línea 2D    | 766       | Corresponde a ejes viales con caracterización de si tienen andén o no y su estado y no a lineas de anden en cada costado de vía, no se indica si el ande se ubica en ambos costados o no. | 
| CARTOGRAFIA                               | ANDENES_CPR                       | Andenes en centros poblados rurales próximos al área urbana                                                                                                          | Línea 2D    | 162       | Corresponde a ejes viales con caracterización de si tienen andén o no y su estado y no a lineas de anden en cada costado de vía, no se indica si el ande se ubica en ambos costados o no. | 
| CARTOGRAFIA                               | ANDENES_PERIMETRO                 | Andenes en zona urbana central                                                                                                                                       | Línea 2D    | 604       | Corresponde a ejes viales con caracterización de si tienen andén o no y su estado y no a lineas de anden en cada costado de vía, no se indica si el ande se ubica en ambos costados o no. | 
| CARTOGRAFIA                               | ANOTACION                         | Puntos de interés rural                                                                                                                                              | Punto 2D    | 1851      | Múltiples anotaciones sin nombre geográfico. Sin atributo de agrupamiento.                                                                                                                | 
| CARTOGRAFIA                               | ANOTACION_URBANO                  | Puntos de interés urbano                                                                                                                                             | Punto 2D    | 158       | Sin atributo de agrupamiento.                                                                                                                                                             | 
| CARTOGRAFIA                               | CURVAS_NIVEL                      | Curvas de nivel, principales cada 200 metros y secundarias cada 50 metros.                                                                                           | Línea 2D    | 149       | No se espeficica el modelo digital de elevación a partir del cual fueron generadas.                                                                                                       | 
| CARTOGRAFIA                               | EDIFICACION_RURAL                 | Nodos de localización de edificaciones en la zona rural                                                                                                              | Punto 2D    | 1828      | Múltiples anotaciones sin nombre geográfico. Sin atributo de agrupamiento.                                                                                                                | 
| CARTOGRAFIA                               | EDUCATIVO                         | Nodos de localización de centros educativos                                                                                                                          | Punto 2D    | 74        | Nombres geográficos completos. Caracter y nivel incompletos.                                                                                                                              | 
| CARTOGRAFIA                               | HIDROGRAFIA                       | Red hidrográfica                                                                                                                                                     | Línea 2D    | 305       | Red discontínua en varias zonas. Incluye nombres de algunos cauces principales. Sin pendiente media, ancho promedio del cauce.                                                            | 
| CARTOGRAFIA                               | HIDROGRAFIA_Buffer                | Rondas hídricas con aferencia de 30 metros a cada lado de las líneas de la red hidrográfica                                                                          | Polígono 2D | 305       | Red discontínua en varias zonas. Incluye nombres de algunos cauces principales.                                                                                                           | 
| CARTOGRAFIA                               | HIDROGRAFIA_Buffer1               | Rondas hídricas con aferencia de 30 metros a cada lado de las líneas de la red hidrográfica y para tramo de drenaje mayoritariamente dentro del límite del municipio | Polígono 2D | 264       | Red discontínua en varias zonas. Incluye nombres de algunos cauces principales.                                                                                                           | 
| CARTOGRAFIA                               | LIM_NBR                           | Núcleo básico rural - Límites de vías y predios                                                                                                                      | Polígono 2D | 146       |                                                                                                                                                                                           | 
| CARTOGRAFIA                               | RONDAS                            | Rondas hídricas                                                                                                                                                      | Polígono 2D | 5         | Red discontínua en varias zonas. Entidades multiparte.                                                                                                                                    | 
| CARTOGRAFIA                               | VIAS_CPR                          | Vías interconectoras desce el centro urbano y hacias centros poblados rurales - CPR                                                                                  | Línea 2D    | 200       | Contiene nombre de vía, tipo, estado y  clasificación. Sin indicación de sentido vial, restricción vehicular, velocidad permitida.                                                        | 
| CARTOGRAFIA                               | VIAS_PERIMETRO                    | Vías perímetro urbano principal                                                                                                                                      | Línea 2D    | 604       | Contiene nombre de vía, tipo, estado y clasificación.                                                                                                                                     | 
| CARTOGRAFIA                               | VIAS_RURALES                      | Vías rurales                                                                                                                                                         | Línea 2D    | 774       | Con atributos provenientes de CAD. Nombre solo en 3 entidades. Sin indicación de sentido vial, restricción vehicular, velocidad permitida.                                                | 
| CARTOGRAFIA                               | VIAS_URBANAS                      | Vías urbanas                                                                                                                                                         | Línea 2D    | 784       | Contiene nombre de vía, tipo, estado y  clasificación. Sin indicación de sentido vial, restricción vehicular, velocidad permitida.                                                        | 
| CARTOGRAFIA                               | VIAS_URBANAS_Buffer               | Aferencia en vías urbanas a 20 metros y solo en 1 costado                                                                                                            | Polígono 2D | 784       | Contiene nombre de vía, tipo, estado y  clasificación.                                                                                                                                    | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | BARRIOS                           | Barrios zona urbana                                                                                                                                                  | Polígono 2D | 49        |                                                                                                                                                                                           | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | Centrospobladosrurales            | Predios en centros poblados rurales                                                                                                                                  | Polígono 2D | 3615      | Clasificación de predios por centro poblado incompleta.                                                                                                                                   | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | COMUNAS                           | Comunas urbanas                                                                                                                                                      | Polígono 2D | 4         | Sin código DANE, sin barrios asociados en todas las comunas.                                                                                                                              | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | NBR                               | Núcleo básico rural - Predios                                                                                                                                        | Polígono 2D | 282       |                                                                                                                                                                                           | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | NucleosBasicosRurales             | Núcleo básico rural - Límites de vías y predios                                                                                                                      | Polígono 2D | 146       |                                                                                                                                                                                           | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | PERIMETRO                         | Perímetro urbano                                                                                                                                                     | Polígono 2D | 1         |                                                                                                                                                                                           | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | PERIMETRO_CPR                     | Perímetro de centros poblados rurales y asentamientos humanos cercanos                                                                                               | Polígono 2D | 26        |                                                                                                                                                                                           | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | PERIMETRO_SymDiff                 | Diferencias entre límite de perímetro urbano y predios                                                                                                               | Polígono 2D | 14        |                                                                                                                                                                                           | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | UNIDAD_MORFOLOGICA                | Unidades morfológicas urbanas                                                                                                                                        | Polígono 2D | 37        | Sin descripción de características arquitectónicas o morfológicas, solo se numeran.                                                                                                       | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | ZONA_URBANA                       | Límite de zona urbana                                                                                                                                                | Polígono 2D | 5         | Sin nombres.                                                                                                                                                                              | 
| ENTIDADES_TERRITORIALES_Y_ADMINISTRATIVAS | ZONA_URBANA_EXPANSION             | Límite zona urbana ajustada a partir de predios                                                                                                                      | Polígono 2D | 2         | Sin nombres.                                                                                                                                                                              | 
...
| RURAL                                     | ZONA_HOMOGENEA_GEOECONOMICA_RURAL | Zonas homogéneas geoeconómicas rurales                                                                                                                               | Polígono 2D | 80        | Sin campo descriptivo con criterio de homogenización.                                                                                                                                     | 
| URBANO                                    | CONSTRUCCION_ANEXA                | Construcciones anexas urbanas                                                                                                                                        | Polígono 2D | 7893      | Incluye descripción de usos.                                                                                                                                                              | 
| URBANO                                    | EDIFICACION                       | Edificaciones urbanas                                                                                                                                                | Polígono 2D | 33984     | Incluye número de pisos                                                                                                                                                                   | 
| URBANO                                    | Edificacion_Altura                | Predios con asociación de altura en edificación por número de pisos                                                                                                  | Polígono 2D | 3165      | No incluye todos los predios urbanos con edificaciones.                                                                                                                                   | 
| URBANO                                    | MANZANA                           | Manzanas catastrales                                                                                                                                                 | Polígono 2D | 711       |                                                                                                                                                                                           | 
| URBANO                                    | NOMENCLATURA_DOMICILIARIA         | Líneas con identificación de nomenclatura de direcciones urbanas                                                                                                     | Línea 2D    | 15144     | Incluye texto descriptor.                                                                                                                                                                 | 
...
| URBANO                                    | ZONA_GEOECONOMICA_URBANA          | Zonas homogéneas geoeconómicas urbanas                                                                                                                               | Polígono 2D | 107       | Sin campo descriptivo con criterio de homogenización.                                                                                                                                     | 
