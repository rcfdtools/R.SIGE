...
| ![R.SIGE](graph/ArcGISPro_Layer_EXP_URBANA_AJUSTADA_PREDIOS_shp.png)  | EXP_URBANA_AJUSTADA_PREDIOS.shp  | Límite zona de expansión urbana a partir de predios                                                               | Polígono 2D | 2         | 
...
| ![R.SIGE](graph/ArcGISPro_Layer_VIAS_PERIMETRO_URBANO_shp.png)        | VIAS_PERIMETRO_URBANO.shp        | Vías perímetro urbano y vías proyectadas. Incluye la zona urbana central, La Paz, Villa del Rosario y Barandillas | Línea 2D    | 761       | 
...
| ![R.SIGE](graph/ArcGISPro_Layer_ZONA_URBANA_AJUSTADA_PREDIOS_shp.png) | ZONA_URBANA_AJUSTADA_PREDIOS.shp | Límite zona urbana ajustada a partir de predios                                                                   | Polígono 2D | 4         | 
