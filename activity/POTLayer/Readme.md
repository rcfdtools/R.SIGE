...
| GIS                                                                                    | Dataset                                    | Nombre                             | Descripción                                                                                                                                                          | Geometría   | Registros | 
|----------------------------------------------------------------------------------------|--------------------------------------------|------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------|-----------| 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANDENES.png)                           | CARTOGRAFIA                                | ANDENES                            | Andenes zona urbana y centros poblados rurales próximos al área urbana                                                                                               | Línea 2D    | 766       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANDENES_CPR.png)                       | CARTOGRAFIA                                | ANDENES_CPR                        | Andenes en centros poblados rurales próximos al área urbana                                                                                                          | Línea 2D    | 162       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANDENES_PERIMETRO.png)                 | CARTOGRAFIA                                | ANDENES_PERIMETRO                  | Andenes en zona urbana central                                                                                                                                       | Línea 2D    | 604       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANOTACION.png)                         | CARTOGRAFIA                                | ANOTACION                          | Puntos de interés rural                                                                                                                                              | Punto 2D    | 1851      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ANOTACION_URBANO.png)                  | CARTOGRAFIA                                | ANOTACION_URBANO                   | Puntos de interés urbano                                                                                                                                             | Punto 2D    | 158       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_CURVAS_NIVEL.png)                      | CARTOGRAFIA                                | CURVAS_NIVEL                       | Curvas de nivel, principales cada 200 metros y secundarias cada 50 metros.                                                                                           | Línea 2D    | 149       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_EDIFICACION_RURAL.png)                 | CARTOGRAFIA                                | EDIFICACION_RURAL                  | Nodos de localización de edificaciones en la zona rural                                                                                                              | Punto 2D    | 1828      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_EDUCATIVO.png)                         | CARTOGRAFIA                                | EDUCATIVO                          | Nodos de localización de centros educativos                                                                                                                          | Punto 2D    | 74        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_HIDROGRAFIA.png)                       | CARTOGRAFIA                                | HIDROGRAFIA                        | Red hidrográfica                                                                                                                                                     | Línea 2D    | 305       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_HIDROGRAFIA_Buffer.png)                | CARTOGRAFIA                                | HIDROGRAFIA_Buffer                 | Rondas hídricas con aferencia de 30 metros a cada lado de las líneas de la red hidrográfica                                                                          | Polígono 2D | 305       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_HIDROGRAFIA_Buffer1.png)               | CARTOGRAFIA                                | HIDROGRAFIA_Buffer1                | Rondas hídricas con aferencia de 30 metros a cada lado de las líneas de la red hidrográfica y para tramo de drenaje mayoritariamente dentro del límite del municipio | Polígono 2D | 264       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_LIM_NBR.png)                           | CARTOGRAFIA                                | LIM_NBR                            | Núcleo básico rural - Límites de vías y predios                                                                                                                      | Polígono 2D | 146       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_RONDAS.png)                            | CARTOGRAFIA                                | RONDAS                             | Rondas hídricas                                                                                                                                                      | Polígono 2D | 5         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_CPR.png)                          | CARTOGRAFIA                                | VIAS_CPR                           | Vías interconectoras desde el centro urbano y hacia centros poblados rurales - CPR                                                                                   | Línea 2D    | 200       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_PERIMETRO.png)                    | CARTOGRAFIA                                | VIAS_PERIMETRO                     | Vías perímetro urbano principal                                                                                                                                      | Línea 2D    | 604       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_RURALES.png)                      | CARTOGRAFIA                                | VIAS_RURALES                       | Vías rurales                                                                                                                                                         | Línea 2D    | 774       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_URBANAS.png)                      | CARTOGRAFIA                                | VIAS_URBANAS                       | Vías urbanas                                                                                                                                                         | Línea 2D    | 784       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VIAS_URBANAS_Buffer.png)               | CARTOGRAFIA                                | VIAS_URBANAS_Buffer                | Aferencia en vías urbanas a 20 metros y solo en 1 costado                                                                                                            | Polígono 2D | 784       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_BARRIOS.png)                           | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | BARRIOS                            | Barrios zona urbana                                                                                                                                                  | Polígono 2D | 49        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_Centrospobladosrurales.png)            | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | Centrospobladosrurales             | Predios en centros poblados rurales                                                                                                                                  | Polígono 2D | 3615      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_COMUNAS.png)                           | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | COMUNAS                            | Comunas urbanas                                                                                                                                                      | Polígono 2D | 4         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_NBR.png)                               | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | NBR                                | Núcleo básico rural - Predios                                                                                                                                        | Polígono 2D | 282       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_NucleosBasicosRurales.png)             | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | NucleosBasicosRurales              | Núcleo básico rural - Límites de vías y predios                                                                                                                      | Polígono 2D | 146       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_PERIMETRO.png)                         | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | PERIMETRO                          | Perímetro urbano                                                                                                                                                     | Polígono 2D | 1         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_PERIMETRO_CPR.png)                     | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | PERIMETRO_CPR                      | Perímetro de centros poblados rurales y asentamientos humanos cercanos                                                                                               | Polígono 2D | 26        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_PERIMETRO_SymDiff.png)                 | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | PERIMETRO_SymDiff                  | Diferencias entre límite de perímetro urbano y predios                                                                                                               | Polígono 2D | 14        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_UNIDAD_MORFOLOGICA.png)                | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | UNIDAD_MORFOLOGICA                 | Unidades morfológicas urbanas                                                                                                                                        | Polígono 2D | 37        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ZONA_URBANA.png)                       | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | ZONA_URBANA                        | Límite de zona urbana                                                                                                                                                | Polígono 2D | 5         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ZONA_URBANA_EXPANSION.png)             | ENTIDADES_TERRITORIALES _Y_ADMINISTRATIVAS | ZONA_URBANA _EXPANSION             | Límite zona urbana ajustada a partir de predios                                                                                                                      | Polígono 2D | 2         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_SECTOR_RURAL.png)                      | RURAL                                      | SECTOR_RURAL                       | Límite catastral zona rural                                                                                                                                          | Polígono 2D | 1         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_TERRENO_PREDIO_RURAL.png)              | RURAL                                      | TERRENO_PREDIO_RURAL               | Predios rurales                                                                                                                                                      | Polígono 2D | 9554      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_VEREDA.png)                            | RURAL                                      | VEREDA                             | Límites veredales                                                                                                                                                    | Polígono 2D | 14        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ZONA_HOMOGENEA_FISICA_RURAL.png)       | RURAL                                      | ZONA_HOMOGENEA _FISICA_RURAL       | Zonas homogéneas físicas rurales                                                                                                                                     | Polígono 2D | 58        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ZONA_HOMOGENEA_GEOECONOMICA_RURAL.png) | RURAL                                      | ZONA_HOMOGENEA _GEOECONOMICA_RURAL | Zonas homogéneas geoeconómicas rurales                                                                                                                               | Polígono 2D | 80        | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_CONSTRUCCION_ANEXA.png)                | URBANO                                     | CONSTRUCCION_ANEXA                 | Construcciones anexas urbanas                                                                                                                                        | Polígono 2D | 7893      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_EDIFICACION.png)                       | URBANO                                     | EDIFICACION                        | Edificaciones urbanas                                                                                                                                                | Polígono 2D | 33984     | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_Edificacion_Altura.png)                | URBANO                                     | Edificacion_Altura                 | Predios con asociación de altura en edificación por número de pisos                                                                                                  | Polígono 2D | 3165      | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_MANZANA.png)                           | URBANO                                     | MANZANA                            | Manzanas catastrales                                                                                                                                                 | Polígono 2D | 711       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_NOMENCLATURA_DOMICILIARIA.png)         | URBANO                                     | NOMENCLATURA _DOMICILIARIA         | Líneas con identificación de nomenclatura de direcciones urbanas                                                                                                     | Línea 2D    | 15144     | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_NOMENCLATURA_VIAL.png)                 | URBANO                                     | NOMENCLATURA_VIAL                  | Nomenclatura de vías urbanas                                                                                                                                         | Línea 2D    | 593       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_SECTOR_URBANO.png)                     | URBANO                                     | SECTOR_URBANO                      | Límite catastral zona urbana                                                                                                                                         | Polígono 2D | 1         | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_TERRENO_PREDIO_URBANO.png)             | URBANO                                     | TERRENO_PREDIO_URBANO              | Predios urbanos                                                                                                                                                      | Polígono 2D | 16750     | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ZONA_GEOECONOMICA_URBANA.png)          | URBANO                                     | ZONA_GEOECONOMICA _URBANA          | Zonas homogéneas geoeconómicas urbanas                                                                                                                               | Polígono 2D | 107       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_ZONA_HOMOGENEA_FISICA_URBANA.png)      | URBANO                                     | ZONA_HOMOGENEA _FISICA_URBANA      | Zonas homogéneas físicas urbanas                                                                                                                                     | Polígono 2D | 107       | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_Regis_shp.png)                         | N/A                                        | Registro1                          | Tabla registro catastral 1 con descriptores de predio                                                                                                                | N/A         | 46305     | 
| ![:globe_with_meridians:](graph/ArcGISPro_Layer_Regis_shp.png)                         | N/A                                        | Registro2                          | Tabla registro catastral 2 con descriptores de construcciones                                                                                                        | N/A         | 31599     | 
