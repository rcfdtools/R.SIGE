...
| [:arrow_backward:](../xxxx) Anterior | [:house:](../../README.md) Inicio | [:beginner:](https://github.com/rcfdtools/R.SIGE/discussions/99999) Ayuda / Colabora | Siguiente [:arrow_forward:]() |
|--------------------------------------|----------------------------------|--------------------------------------------------------------------------------------|-------------------------------|
